    ...
    namespace Network
    {
        namespace Protocol
        {
            ...
            public abstract class BaseMessage : ISerializable
            {
                ...
                /// </summary>
                /// <returns></returns>
                public abstract void Write(ByteWriter byteWriter, SerializerOption serializerOption);
                ...
                public abstract void Read(ref ByteReader byteReader, SerializerOption serializerOption);
