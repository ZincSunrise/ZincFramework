...
namespace ZincFramework.Binary.Serialization.MetaModule
{
    internal partial class DefaultMetaModule : IMetaModule
    {
        ...
        internal static bool IsBlittable(Type type) => type.IsValueType && (_converterMaps.ContainsKey(type) || typeof(IBlittable).IsAssignableFrom(type));
