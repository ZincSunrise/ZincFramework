...
namespace ZincFramework
{
    public static class ArrayListUtility
    {
        ...
        #region 对象池数组相关
        public static void Fill<T>(T[] array, DataPool<T> dataPool) where T : class, IResumable
        {
        ...
        public static void Fill<T>(T[] array, Func<T> factory) where T : class, IResumable
        {
            for (int i = 0; i < array.Length; i++)
            {
        ...
        public static void Clear<T>(T[] array, DataPool<T> dataPool) where T : class, IResumable
        {
            for (int i = 0; i < array.Length; i++)
            {
                if (array[i] != null)
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="array"></param>
        public static void Clear<T>(T[] array) where T : class, IResumable
        {
            for (int i = 0; i < array.Length; i++)
            {
                if (array[i] != null)
        ...
        public static void Clear<T>(IList<T> list) where T : class, IResumable
        {
