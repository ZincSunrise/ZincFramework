...
namespace ZincFramework
{
    namespace UI
    {
        public class UIManager : BaseSafeSingleton<UIManager>
        {
            ...
            public void ShowPanel<T>(bool isAsync, E_UILayerType layerType = E_UILayerType.Middle, UnityAction<T> callback = null) where T : BasePanel
            {
                ...
                AssetBundleManager.Instance.LoadAssetAsync<GameObject>("ui", panelName, (prefab) => InitializePanel<T>(prefab, layerType, panelName), isAsync);
            }
