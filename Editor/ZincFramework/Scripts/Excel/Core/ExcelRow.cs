...
namespace ZincFramework
{
    namespace Excel
    {
        ...
        public class ExcelRow
        {
            ...
            public ExcelRow(Row row, CreateCell createCell, GetValueInCell getAction, SetValueInCell setAction) 
            {
                ...
                foreach (var cell in row.Descendants<Cell>())
                {
                    ...
                    _excelCells.Add(cellIndex, new ExcelCell(cell, getAction, setAction));
